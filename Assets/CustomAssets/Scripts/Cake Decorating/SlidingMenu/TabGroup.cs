...
public class TabGroup : MonoBehaviour
{
    ...
    public void OnTabSelected(TabButton _tabButton)
    {
        ...
        _tabButton.transform.GetChild(0).GetComponent<Image>().sprite = _tabButton.m_selectedIcon;
    ...
    public void ResetTabs()
    {
        foreach (TabButton _button in m_tabButtons)
        {
            ...
            _button.transform.GetChild(0).GetComponent<Image>().sprite = _button.m_deselectedIcon;
        }
    }
}
